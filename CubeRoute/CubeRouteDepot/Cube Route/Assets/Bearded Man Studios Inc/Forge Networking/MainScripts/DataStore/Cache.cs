...
namespace BeardedManStudios.Network
{
    ...
    public static class Cache
    {
        ...
        /// </summary>
        private static Dictionary<string, CachedObject> memory = new Dictionary<string, CachedObject>();
        ...
        private static void RemoveExpiredObjects()
        {
        ...
        public static void NetworkReadServer( NetworkingPlayer player, NetworkingStream stream )
        {
            ...
            // Let the client know it is null
            if ( obj == null )
                return;
