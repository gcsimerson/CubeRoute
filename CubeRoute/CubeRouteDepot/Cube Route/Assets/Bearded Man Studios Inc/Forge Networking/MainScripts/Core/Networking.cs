...
namespace BeardedManStudios.Network
{
    public class Networking
    {
        ...
        private static ConnectionEvent connectedInvoker;    // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private static NetWorker.PingReceived pingReceivedInvoker;    // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private static NetWorker.LANEndPointFound lanEndPointFoundInvoker;    // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private static NetWorker.BasicEvent networkResetInvoker;    // Because iOS doesn't have a JIT - Multi-cast function pointer.
...
#if !NETFX_CORE
            // Allow user to pass in the variables needed to pass into this begin function
        ...
        #region Broken v18 LanDiscovery
        ...
        #endregion Broken v18 LanDiscovery

        #region Working v17 LanDiscovery
        ...
        #endregion Working v17 LanDiscovery
        ...
        public static void Disconnect( ushort port )
        {
            ...
            // Go through all the NetworkedMonoBehaviors and clean them up
        }
        ...
        private static void ThreadPing( object hostObj )
        {
            ...
            do
            {
                ...
                if ( counter++ >= maxTries )
                    return; // Fire off a failed event
