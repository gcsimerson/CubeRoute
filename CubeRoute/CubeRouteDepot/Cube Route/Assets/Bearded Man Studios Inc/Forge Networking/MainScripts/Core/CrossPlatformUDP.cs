...
namespace BeardedManStudios.Network
{
    public class CrossPlatformUDP : NetWorker
    {
        ...
        private NetworkMessageEvent dataSentInvoker;    // Because iOS is stupid - Multi-cast function pointer.
        ...
        private NetworkUDPMessageEvent udpDataReadInvoker;  // Because iOS is stupid - Multi-cast function pointer.
        ...
        // Modify write to support one cached packet
        ...
        private void PacketReceived( string endpoint, BMSByte bytes )
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        // If this eventually sends something to the player they will not exist
                        Disconnect( sender );
                        return;
                    }
                }
            ...
            // Look into if this is still required
...
#endif
        {
            ...
            do
            {
                ...
                catch ( SocketException ex )
                {
                    ...
                    {
                        // In the master server capture this error and see who it is, then remove them from the hosts list
        ...
        #endregion Initial Data Read In
    }
}