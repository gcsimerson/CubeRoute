...
namespace BeardedManStudios.Network
{
    public abstract class NetWorker
    {
        ...
        public void SetThreadSpeed( int speed )
        {
            ThreadSpeed = speed;
        }
        ...
        private BasicEvent connectedInvoker;    // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private BasicEvent disconnectedInvoker;   // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private BasicEvent connectTimeoutInvoker;    // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private StringResponseEvent serverDisconnectedInvoker;  // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private DynamicCommandEvent clientReadyInvoker;
        ...
        private NetworkErrorEvent errorInvoker; // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private NetworkMessageEvent dataSentInvoker;    // Because iOS doesn't have a JIT - Multi-cast function pointer.

        protected void OnDataSent( NetworkingStream stream )
        {
            if ( dataSentInvoker != null ) dataSentInvoker( stream );
        }
        ...
        private DirectNetworkMessageEvent dataReadInvoker;  // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private DirectRawNetworkMessageEvent rawDataReadInvoker;    // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private PlayerConnectionEvent playerConnectedInvoker;   // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private PlayerConnectionEvent playerDisconnectedInvoker;    // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        private PlayerBannedEvent playerBannedInvoker;
        ...
        private BasicEvent timeoutDisconnectedInvoker;  // Because iOS doesn't have a JIT - Multi-cast function pointer.
        ...
        #endregion Timeout Disconnect

        public void ThrowException( NetworkException exception )
        {
            OnError( exception );
        }
        ...
        protected void OnCustomDataRead( uint id, NetworkingPlayer player, NetworkingStream stream )
        {
            if ( customDataRead.ContainsKey( id ) ) customDataRead[id]( player, stream );
        }
        ...
        private PingEvent pingEventInvoker;
