...
namespace BeardedManStudios.Network
{
	...
	public class SimpleNetworkedMonoBehavior : MonoBehaviour, INetworkingSerialized
	{
		...
		/// <summary>
		/// If the game is currently in single player mode OR we are the owner of this networked object.
		/// (Added by Cookie Dough Studios.)
		/// </summary>
		public bool IsSinglePlayerOrOwner
		{
			get { return IsOffline || IsOwner; }
		}

		/// <summary>
		/// If this machine is connected to the server as a client.
		/// (Added by Cookie Dough Studios.)
		/// </summary>
		public bool IsClient
		{
			get { return ( IsOnline && !Networking.PrimarySocket.IsServer ); }
		}

		/// <summary>
		/// If this machine is connected to the server as the server.
		/// (Added by Cookie Dough Studios.)
		/// </summary>
		...
		/// <summary>
		/// If this machine is either disconnected or connected to the server as the server.
		/// (Added by Cookie Dough Studios.)
		/// </summary>
		public bool IsOfflineOrServer
		{
			get { return ( IsOffline || Networking.PrimarySocket.IsServer ); }
		}

		/// <summary>
		/// If this machine is connected to port 15987.
		/// (Added by Cookie Dough Studios.)
		/// </summary>
		public bool IsOnline
		{
			get { return Networking.IsConnected( 15987 ); }
		}

		/// <summary>
		/// If this machine is NOT connected to port 15987.
		/// (Added by Cookie Dough Studios.)
		/// </summary>
		...
		public int GetSceneNetworkedId()
		{
			return sceneNetworkedId;
		}

		// Optimization when an object is removed there needs to be a way to replace its spot
		/// <summary>
		...
		public static void SetupObjects( SimpleNetworkedMonoBehavior[] behaviors, NetWorker owningSocket )
		{
			...
			// Got through all objects in NetworkingManager stack and set them up
