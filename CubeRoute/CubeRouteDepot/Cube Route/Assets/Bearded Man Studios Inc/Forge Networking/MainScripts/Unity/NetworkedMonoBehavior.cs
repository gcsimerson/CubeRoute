...
namespace BeardedManStudios.Network
{
    ...
    public class NetworkedMonoBehavior : SimpleNetworkedMonoBehavior
    {
        ...
        private ProximityEvent enteredProximityInvoker;
        ...
        private ProximityEvent exitedProximityInvoker;
        ...
        #endregion Authoritative Frame History
        ...
        protected override void Reflect()
        {
...
#endif
            {
...
#endif
                {
                    ...
                    // Getter and setter should be bound to delegate as fields are
        ...
        protected override void UnityUpdate()
        {
            ...
            // Examine other parts of removal for this
            ...
            else
            {
                ...
                if ( clientSidePrediction && IsOwner )
                {
                    ...
                    {
                        // If the player is too far from targetPosition then fix it
                        OwnedUpdate();
                        return;
                    }
                }
