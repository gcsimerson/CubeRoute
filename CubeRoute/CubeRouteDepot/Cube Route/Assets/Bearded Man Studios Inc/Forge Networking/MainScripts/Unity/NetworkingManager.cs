...
namespace BeardedManStudios.Network
{
	...
	public class NetworkingManager : SimpleNetworkedMonoBehavior
	{
		...
		/// </summary>
		new public static bool IsOnline // "new" added by Cookie Dough Studios
		{
			get
			{
		...
		// Complete the ideas of frame intervals
		public int frameInterval = 100;

		// Complete the ideas of frame intervals
		public byte CurrentFrame { get { return (byte)( SimulatedServerTime * 1000 / frameInterval ); } }

		public byte GetFrameCountFromTime( double milliseconds )
		{
			return (byte)( milliseconds / frameInterval );
		}
